...
use num_traits::One;
use sha3::Digest;
use metamorphic_testing_rs::kyber_argyle_metamorphic::{KyberArgyleCipherBitFlipMetamorphicTest, KyberArgyleCipherSingleBitMutation, KyberArgyleFakeRngBitMutation, KyberArgyleFakeRngMetamorphicTest, KyberArgyleInput};
...
fn main() {
    ...
    let res = KyberArgyleFakeRngMetamorphicTest::test_all(&mut KyberArgyleFakeRngBitMutation::new(&KyberArgyleInput::new()));
    println!("{}", res);
